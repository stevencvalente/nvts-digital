...
const BoldStatement = () => {
  ...
  return (
    <section ref={containerRef} className="relative bg-foreground py-20 md:py-28 lg:py-32 pb-72 md:pb-96 lg:pb-[28rem] px-6 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          {t.bold.line1}
          <br />
          <span className="text-primary text-5xl md:text-8xl">{t.bold.line2}</span>
        </motion.h2>
        <motion.p
