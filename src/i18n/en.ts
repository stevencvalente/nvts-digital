...
export const en: Translations = {
  ...
  "hero": {
    ...
    "line2": "Five pillars.",
    "line3": "Real results.",
    "description": "I help ambitious companies generate more revenue, reduce operational friction and build digital experiences that actually perform across every layer of the stack",
  ...
  "parallax": {
    "features": [
      ...
      },
      {
        ...
        "description": "No 80-page decks. I build, launch, and iterate websites, automations, integrations in weeks, not quarters."
      },
      {
        "label": "Growth",
        "title": "Grow further. Grow faster.",
        "description": "Every system I build is designed to scale. Data compounds. Automations multiply. Your edge widens every month."
      }
    ]
  },
  "diagnose": {
  ...
  "about": {
    ...
    "description": "With over 10 years in digital consulting, I've helped companies across e-commerce, retail and B2B transform the way they operate, grow and compete. I work across the full digital stack from data architecture to customer experience, from AI strategy to paid acquisition so nothing falls through the cracks.",
    "stats": [
      "10+ years experience",
  ...
  "beforeAfter": {
    ...
    "subheading": "Drag the slider to see the transformation.",
    "beforeLabel": "Before",
    "afterLabel": "After"
  },
  "footer": {
