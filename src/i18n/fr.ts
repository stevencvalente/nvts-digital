...
export const fr: Translations = {
  ...
  "bold": {
    ...
    "line2": "Je transforme.",
    "subtitle": "Votre agence gère une chose. Votre développeur en gère une autre. Pendant ce temps, vous perdez de l'argent."
  },
  "services": {
    ...
    "pillars": [
      {
        ...
        "problemQuote": "Nos données produit sont réparties dans 5 tableurs, nos actifs sont dispersés sur des drives partagés, et personne ne fait confiance aux chiffres de nos rapports.",
        "whatIDo": "J'audite vos flux de données, j'implémente une source unique de vérité pour les informations produit et les actifs numériques, et je construis des dashboards analytics qui donnent à chaque équipe la même vision fiable."
      },
      {
  ...
  "about": {
    ...
    "description": "Avec plus de 10 ans en conseil digital, j'ai aidé des entreprises en e-commerce, retail et B2B à transformer leur façon d'opérer, de croître et de concurrencer. Je travaille sur l'ensemble du stack digital, de l'architecture données à l'expérience client, de la stratégie IA à l'acquisition payante, pour que rien ne passe entre les mailles.",
    "stats": [
      "10+ ans d'expérience",
      "30+ projets livrés",
      "5 piliers d'expertise"
    ]
  },
  "contact": {
